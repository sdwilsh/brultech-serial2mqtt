...
def forgiving_round(value, precision=..., method=..., default=...): # -> int | float | object:
...
def timestamp_custom(value, date_format=..., local=..., default=...): # -> str | object:
...
_regex_cache = ...
def regex_replace(value=..., find=..., replace=..., ignorecase=...): # -> AnyStr@compile:
    """Replace using regex."""
    ...
...
def regex_findall_index(value, find=..., index=..., ignorecase=...): # -> AnyStr@compile:
...
class TemplateEnvironment(ImmutableSandboxedEnvironment):
    ...
    def compile(self, source: str | jinja2.nodes.Template, name: str | None = ..., filename: str | None = ..., raw: bool = ..., defer_init: bool = ...) -> CodeType | str:
