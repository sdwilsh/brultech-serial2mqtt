...
class HomeAssistant:
    ...
    @callback
    def async_add_job(self, target: Callable[..., Coroutine[Any, Any, _R] | _R] | Coroutine[Any, Any, _R], *args: Any) -> asyncio.Future[_R] | None:
        """Add a job to be executed by the event loop or by an executor.
    ...
    @callback
    def async_run_job(self, target: Callable[..., Coroutine[Any, Any, _R] | _R] | Coroutine[Any, Any, _R], *args: Any) -> asyncio.Future[_R] | None:
...
_FilterableJobType = tuple[HassJob[[Event], Coroutine[Any, Any, None] | None], Callable[[Event], bool] | None, bool,]
class EventBus:
