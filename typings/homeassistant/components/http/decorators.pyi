...
_P = ...
_FuncType = Callable[Concatenate[_HomeAssistantViewT, Request, _P], Coroutine[Any, Any, Response]]
@overload
...
def require_admin(_func: _FuncType[_HomeAssistantViewT, _P] | None = ..., *, error: Unauthorized | None = ...) -> (Callable[[_FuncType[_HomeAssistantViewT, _P]], _FuncType[_HomeAssistantViewT, _P]] | _FuncType[_HomeAssistantViewT, _P]):
