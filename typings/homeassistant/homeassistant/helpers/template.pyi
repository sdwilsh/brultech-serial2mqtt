...
def regex_match(value, find=..., ignorecase=...):
...
def regex_search(value, find=..., ignorecase=...):
    """Search using regex."""
    ...

def regex_findall_index(value, find=..., index=..., ignorecase=...):
    """Find all matches using regex and then pick specific match index."""
    ...

def regex_findall(value, find=..., ignorecase=...):
...
class TemplateEnvironment(ImmutableSandboxedEnvironment):
    ...
    def is_safe_attribute(self, obj, attr, value):
        ...
        ...
    def compile(self, source, name=..., filename=..., raw=..., defer_init=...):
