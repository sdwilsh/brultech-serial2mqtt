...
from voluptuous.error import BooleanInvalid, DirInvalid, EmailInvalid, FalseInvalid, FileInvalid, PathInvalid, TrueInvalid, UrlInvalid
...
DOMAIN_REGEX = ...
__author__ = ...
def truth(f): # -> _Wrapped[(...), Unknown, (v: Unknown), Unknown]:
...
class _WithSubValidators:
    ...
    def __voluptuous_compile__(self, schema): # -> (path: Unknown, value: Unknown) -> Unknown:
        ...
...
class Range:
    ...
    """
    def __init__(self, min=..., max=..., min_included=..., max_included=..., msg=...) -> None:
        ...
...
class ExactSequence:
    ...
    def __call__(self, v): # -> list[Unknown] | tuple[Unknown, ...]:
        ...
...
class Unique:
    ...
    def __repr__(self): # -> Literal['Unique()']:
        ...
...
class Number:
    ...
    Decimal('1234.01')
    """
    def __init__(self, precision=..., scale=..., msg=..., yield_decimal=...) -> None:
        ...
    
    def __call__(self, v): # -> Decimal:
        """
