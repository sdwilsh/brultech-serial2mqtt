...
def message(
    default=..., cls=...
):  # -> (f: Unknown) -> _Wrapped[(...), Unknown, (msg: Unknown | None = None, clsoverride: Unknown | None = None), _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), Unknown]]:
...
def validate(
    *a, **kw
):  # -> (func: Unknown) -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), Unknown]:
