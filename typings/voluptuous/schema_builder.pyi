...
def default_factory(value): # -> () -> Unknown:
    ...

@contextmanager
def raises(exc, msg=..., regex=...): # -> Generator[None, None, None]:
    ...
...
class Schema:
    ...
    def extend(self, schema, required=..., extra=...): # -> Self@Schema:
...
class Exclusive(Optional):
    ...
    """
    def __init__(self, schema, group_of_exclusion, msg=..., description=...) -> None:
        ...
...
class Inclusive(Optional):
    ...
    True
    """
    def __init__(self, schema, group_of_inclusion, msg=..., description=..., default=...) -> None:
        ...
...
class Remove(Marker):
    ...
    [1, 2, 3, 5, '7']
    """
    def __call__(self, v): # -> Type[Remove]:
        ...
...
def message(default=..., cls=...): # -> (f: Unknown) -> _Wrapped[(...), Unknown, (msg: Unknown | None = None, clsoverride: Unknown | None = None), _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), Unknown]]:
...
def validate(*a, **kw): # -> (func: Unknown) -> _Wrapped[(...), Unknown, (*args: Unknown, **kwargs: Unknown), Unknown]:
